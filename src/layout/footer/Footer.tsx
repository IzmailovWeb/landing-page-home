            ...
            <Container>
                <FlexWrapper justify={"space-between"} wrap={"nowrap"}>
                    ...
                    <InputBox>
                        ...
                        <Text>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.</Text>
                ...
                <FlexWrapper justify={"center"}>
                    <LogoBox>
                        ...
                        <Copyright>+47 (0) 702 88 12 34 — example@webflow.io — Klubbvika 12, 8310 Kabelvag, Norway</Copyright>
                    </LogoBox>
                </FlexWrapper>
            </Container>
        </StyledFooteer>
